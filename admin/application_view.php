...
?>
<div style="margin-bottom:16px"><a href="applications.php" style="color:var(--adm-muted);font-size:14px">&larr; Back to Applications</a></div>

<div class="adm-panel">
  <div class="adm-panel-head">
    <div>
      <h3><?= e($app['business_name']) ?></h3>
      <div class="sub"><?= e($entityLabels[$app['entity_type']] ?? $app['entity_type']) ?> &middot; <?= e($app['state']) ?></div>
    </div>
...
<div class="adm-panel">
  <div class="adm-panel-head"><h3>Identity Verification</h3></div>
  <div class="adm-detail-grid">
    ...
    <div><div class="k">ID Document</div><div class="v">
      <?php if ($app['user_id_document_path']): ?>
        <a href="../<?= e($app['user_id_document_path']) ?>" target="_blank" class="adm-btn adm-btn-outline adm-btn-sm">View Uploaded ID</a>
...
<div class="adm-panel" style="margin-bottom:0">
  <div class="adm-panel-head"><h3>Update Status</h3></div>
  <form method="post">
    ...
    <button type="submit" class="adm-btn adm-btn-primary">Save Update</button>
  </form>
</div>
