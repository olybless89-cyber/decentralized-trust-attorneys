...
<header class="topnav">
  <div class="container">
    ...
    <div class="nav-actions">
      ...
      <?php else: ?>
        <a href="<?= $__base ?? '' ?>login.php?mode=login" class="btn btn-outline btn-sm">Login</a>
        <a href="<?= $__base ?? '' ?>login.php?mode=signup" class="btn btn-primary btn-sm" style="min-width:92px">Sign Up</a>
      <?php endif; ?>
    </div>
  </div>
</header>
