...
function wallet_provider_logo(string $name): ?string {
    $map = [
        ...
        'Ledger Live'            => '/assets/wallets/ledger-live.png',
        'SafePal'                => '/assets/wallets/safepal.png',
        'Binance Wallet'         => '/assets/wallets/binance-wallet.png',
        'imToken'                => '/assets/wallets/imtoken.png',
        'Guarda'                 => '/assets/wallets/guarda.png',
        'Atomic Wallet'          => '/assets/wallets/atomic-wallet.png',
